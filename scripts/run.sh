...
python3 ${SUPPA_PATH}/suppa.py psiPerEvent -i ../../files-from-ashley/suppa_results_ncbi_trans/flybase_events -e ${RES_DIR}/analysis/suppa/iso_tpm_merged.txt -o ${RES_DIR}/analysis/suppa/earlyEmbryo_events 2> ${RES_DIR}/analysis/suppa/errors_iso_tpm_merged.txt