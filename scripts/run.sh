...
python3 ${PATH_TO_SUPPA}/suppa.py psiPerEvent -i ../../files-from-ashley/suppa_results_ncbi_trans/flybase_events -e ${RES_DIR}/analysis/suppa/merged.tpm -o ${RES_DIR}/analysis/suppa/earlyEmbryo_events