...
python3 ./rna/3_suppa_merge.py ${RES_DIR}/analysis/suppa ${PATH_TO_SUPPA}
#ython3 ${PATH_TO_SUPPA}/suppa.py psiPerEvent -i ../../files-from-ashley/suppa_results_ncbi_trans/flybase_events -e ${RES_DIR}/analysis/suppa/merged.tpm -o ${RES_DIR}/analysis/suppa/earlyEmbryo_events 2> ${RES_DIR}/analysis/suppa/errors_iso_tpm_merged.txt